package id.coding.android.muslim;
...
public class produkok extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_produkok);
        ...
        btn_cari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(keyword.getText())){
                    ...
                    Toast.makeText(produkok.this, "Masukkan nama barang, nama produsen atau nomor sertifikat.",
    ...
    private void dapatkanData() {
        ...
        produkHalal.enqueue(new Callback<ProdukHalal>() {
            ...
            public void onFailure(Call<ProdukHalal> call, Throwable t) {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(produkok.this,"Gagal memuat hasil, perisak koneksi internet anda.",Toast.LENGTH_LONG).show();
